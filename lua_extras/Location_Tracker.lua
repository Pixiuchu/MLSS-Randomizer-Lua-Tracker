...
function loadLocFlags()
    ...
    if optionDigspots() >= 1 then x4589_1 = {1, 0x4589}; x4589_1 = locFlag(x4589_1); if has("Thunderhand") and canDig() then canrOutskirts = canrOutskirts + flip(x4589_1) end; sumrOutskirts = sumrOutskirts - x4589_1 end --Airport Center Digspot 1
    if optionDigspots() >= 1 then x4589_2 = {2, 0x4589}; x4589_2 = locFlag(x4589_2); if has("Thunderhand") and canDig() then canrOutskirts = canrOutskirts + flip(x4589_2) end; sumrOutskirts = sumrOutskirts - x4589_2 end --Airport Center Digspot 2
    if optionDigspots() >= 1 then x4589_3 = {3, 0x4589}; x4589_3 = locFlag(x4589_3); if has("Thunderhand") and canDig() then canrOutskirts = canrOutskirts + flip(x4589_3) end; sumrOutskirts = sumrOutskirts - x4589_3 end --Airport Center Digspot 3
    if optionDigspots() >= 1 then x4589_4 = {4, 0x4589}; x4589_4 = locFlag(x4589_4); if has("Thunderhand") and canDig() then canrOutskirts = canrOutskirts + flip(x4589_4) end; sumrOutskirts = sumrOutskirts - x4589_4 end --Airport Center Digspot 4
    if optionDigspots() == 2 then x4589_5 = {5, 0x4589}; x4589_5 = locFlag(x4589_5); if has("Thunderhand") and canDig() then canrOutskirts = canrOutskirts + flip(x4589_5) end; sumrOutskirts = sumrOutskirts - x4589_5 end --Airport Center Digspot 5
    if optionDigspots() >= 1 then x4589_6 = {6, 0x4589}; x4589_6 = locFlag(x4589_6); if has("Thunderhand") and canDig() then canrOutskirts = canrOutskirts + flip(x4589_6) end; sumrOutskirts = sumrOutskirts - x4589_6 end --Airport Eastside Digspot 1
    if optionDigspots() >= 1 then x4589_7 = {7, 0x4589}; x4589_7 = locFlag(x4589_7); if has("Thunderhand") and canDig() then canrOutskirts = canrOutskirts + flip(x4589_7) end; sumrOutskirts = sumrOutskirts - x4589_7 end --Airport Eastside Digspot 2
    if optionDigspots() >= 1 then x458A_0 = {0, 0x458A}; x458A_0 = locFlag(x458A_0); if has("Thunderhand") and canDig() then canrOutskirts = canrOutskirts + flip(x458A_0) end; sumrOutskirts = sumrOutskirts - x458A_0 end --Airport Eastside Digspot 3
    if optionDigspots() >= 1 then x458A_1 = {1, 0x458A}; x458A_1 = locFlag(x458A_1); if has("Thunderhand") and canDig() then canrOutskirts = canrOutskirts + flip(x458A_1) end; sumrOutskirts = sumrOutskirts - x458A_1 end --Airport Eastside Digspot 4
    if optionDigspots() == 2 then x458A_2 = {2, 0x458A}; x458A_2 = locFlag(x458A_2); if has("Thunderhand") and canDig() then canrOutskirts = canrOutskirts + flip(x458A_2) end; sumrOutskirts = sumrOutskirts - x458A_2 end --Airport Eastside Digspot 5
    if optionDigspots() == 2 then x4588_2 = {2, 0x4588}; x4588_2 = locFlag(x4588_2); if has("Thunderhand") and canDig() then canrOutskirts = canrOutskirts + flip(x4588_2) end; sumrOutskirts = sumrOutskirts - x4588_2 end --Airport Entrance Digspot
    if optionDigspots() == 2 then x4588_3 = {3, 0x4588}; x4588_3 = locFlag(x4588_3); if has("Thunderhand") and canDig() then canrOutskirts = canrOutskirts + flip(x4588_3) end; sumrOutskirts = sumrOutskirts - x4588_3 end --Airport Lobby Digspot
    if optionDigspots() >= 1 then x4588_4 = {4, 0x4588}; x4588_4 = locFlag(x4588_4); if has("Thunderhand") and canDig() then canrOutskirts = canrOutskirts + flip(x4588_4) end; sumrOutskirts = sumrOutskirts - x4588_4 end --Airport Westside Digspot 1
    if optionDigspots() >= 1 then x4588_5 = {5, 0x4588}; x4588_5 = locFlag(x4588_5); if has("Thunderhand") and canDig() then canrOutskirts = canrOutskirts + flip(x4588_5) end; sumrOutskirts = sumrOutskirts - x4588_5 end --Airport Westside Digspot 2
    if optionDigspots() >= 1 then x4588_6 = {6, 0x4588}; x4588_6 = locFlag(x4588_6); if has("Thunderhand") and canDig() then canrOutskirts = canrOutskirts + flip(x4588_6) end; sumrOutskirts = sumrOutskirts - x4588_6 end --Airport Westside Digspot 3
    if optionDigspots() >= 1 then x4588_7 = {7, 0x4588}; x4588_7 = locFlag(x4588_7); if has("Thunderhand") and canDig() then canrOutskirts = canrOutskirts + flip(x4588_7) end; sumrOutskirts = sumrOutskirts - x4588_7 end --Airport Westside Digspot 4
    if optionDigspots() == 2 then x4589_0 = {0, 0x4589}; x4589_0 = locFlag(x4589_0); if has("Thunderhand") and canDig() then canrOutskirts = canrOutskirts + flip(x4589_0) end; sumrOutskirts = sumrOutskirts - x4589_0 end --Airport Westside Digspot 5
    ...
    if optionDigspots() >= 1 then x4576_3 = {3, 0x4576}; x4576_3 = locFlag(x4576_3); if canDig() and has("Thunderhand") then canrOutskirts = canrOutskirts + flip(x4576_3) end; sumrOutskirts = sumrOutskirts - x4576_3 end --Beanbean Outskirts E Digspot 2
    ...
    if optionDigspots() >= 1 then x4571_5 = {5, 0x4571}; x4571_5 = locFlag(x4571_5); if canDig() and has("Thunderhand") then canrOutskirts = canrOutskirts + flip(x4571_5) end; sumrOutskirts = sumrOutskirts - x4571_5 end --Beanbean Outskirts Farm Room Digspot 1
    if optionDigspots() == 2 then x4571_6 = {6, 0x4571}; x4571_6 = locFlag(x4571_6); if canDig() and has("Thunderhand") then canrOutskirts = canrOutskirts + flip(x4571_6) end; sumrOutskirts = sumrOutskirts - x4571_6 end --Beanbean Outskirts Farm Room Digspot 2
    if optionDigspots() == 2 then x4571_7 = {7, 0x4571}; x4571_7 = locFlag(x4571_7); if canDig() and has("Thunderhand") then canrOutskirts = canrOutskirts + flip(x4571_7) end; sumrOutskirts = sumrOutskirts - x4571_7 end --Beanbean Outskirts Farm Room Digspot 3
    x434B_0 = {0, 0x434B}; x434B_0 = locFlag(x434B_0); if has("Thunderhand") then canrOutskirts = canrOutskirts + flip(x434B_0) end; sumrOutskirts = sumrOutskirts - x434B_0 --Beanbean Outskirts Farm Room Mole Reward 1
    x434B_0 = {0, 0x434B}; x434B_0 = locFlag(x434B_0); if has("Thunderhand") then canrOutskirts = canrOutskirts + flip(x434B_0) end; sumrOutskirts = sumrOutskirts - x434B_0 --Beanbean Outskirts Farm Room Mole Reward 2
    ...
    if optionDigspots() >= 1 then x4576_0 = {0, 0x4576}; x4576_0 = locFlag(x4576_0); if canDig() and has("Thunderhand") then canrOutskirts = canrOutskirts + flip(x4576_0) end; sumrOutskirts = sumrOutskirts - x4576_0 end --Beanbean Outskirts NE Digspot 1
    ...
    x4574_6 = {6, 0x4574}; x4574_6 = locFlag(x4574_6); if has("Thunderhand") and has("Hammers3") then canrOutskirts = canrOutskirts + flip(x4574_6) end; sumrOutskirts = sumrOutskirts - x4574_6 --Beanbean Outskirts S Room 1 Block
    if optionCoins() then x4574_5 = {5, 0x4574}; x4574_5 = locFlag(x4574_5); if has("Thunderhand") and has("Hammers3") then canrOutskirts = canrOutskirts + flip(x4574_5) end; sumrOutskirts = sumrOutskirts - x4574_5 end --Beanbean Outskirts S Room 1 Coin Block
    ...
    if optionDigspots() >= 1 then x4574_7 = {7, 0x4574}; x4574_7 = locFlag(x4574_7); if has("Thunderhand") and has("Hammers3") and canDig() then canrOutskirts = canrOutskirts + flip(x4574_7) end; sumrOutskirts = sumrOutskirts - x4574_7 end --Beanbean Outskirts S Room 1 Digspot 2
    ...
    x434E_1 = {1, 0x434E}; x434E_1 = locFlag(x434E_1); if has("Thunderhand") and has("Hammers2") then canrOutskirts = canrOutskirts + flip(x434E_1) end; sumrOutskirts = sumrOutskirts - x434E_1 --Beanbean Outskirts Secret Scroll 1
    x434E_2 = {2, 0x434E}; x434E_2 = locFlag(x434E_2); if has("Thunderhand") and has("Hammers3") then canrOutskirts = canrOutskirts + flip(x434E_2) end; sumrOutskirts = sumrOutskirts - x434E_2 --Beanbean Outskirts Secret Scroll 2
    ...
    x4359_5 = {5, 0x4359}; x4359_5 = locFlag(x4359_5); if has("Thunderhand") then canrOutskirts = canrOutskirts + flip(x4359_5) end; sumrOutskirts = sumrOutskirts - x4359_5 --Beanbean Outskirts Super Hammer Upgrade
    ...
    x4373_3 = {3, 0x4373}; x4373_3 = locFlag(x4373_3); if has("Thunderhand") then canrOutskirts = canrOutskirts + flip(x4373_3) end; sumrOutskirts = sumrOutskirts - x4373_3 --Beanbean Outskirts Thunderhand Mole
    x4359_6 = {6, 0x4359}; x4359_6 = locFlag(x4359_6); if has("Thunderhand") and canBeanstar() then canrOutskirts = canrOutskirts + flip(x4359_6) end; sumrOutskirts = sumrOutskirts - x4359_6 --Beanbean Outskirts Ultra Hammer Upgrade
    ...
    if optionBowser() then --
        x459B_5 = {5, 0x459B}; x459B_5 = locFlag(x459B_5); if canBirdo() and optionHardLogic() and has("RedGoblet") and has("Thunder") then canrBowser = canrBowser + flip(x459B_5) end; sumrBowser = sumrBowser - x459B_5 --Bowser's Castle Before Fawful Fight Block 1
        x459B_6 = {6, 0x459B}; x459B_6 = locFlag(x459B_6); if canBirdo() and optionHardLogic() and has("RedGoblet") and has("Thunder") then canrBowser = canrBowser + flip(x459B_6) end; sumrBowser = sumrBowser - x459B_6 --Bowser's Castle Before Fawful Fight Block 2
        x459D_1 = {1, 0x459D}; x459D_1 = locFlag(x459D_1); if canBirdo() and optionHardLogic() and has("RedGoblet") and has("Thunder") then canrBowser = canrBowser + flip(x459D_1) end; sumrBowser = sumrBowser - x459D_1 --Bowser's Castle Before Wendy Fight Block 1
        x459D_2 = {2, 0x459D}; x459D_2 = locFlag(x459D_2); if canBirdo() and optionHardLogic() and has("RedGoblet") and has("Thunder") then canrBowser = canrBowser + flip(x459D_2) end; sumrBowser = sumrBowser - x459D_2 --Bowser's Castle Before Wendy Fight Block 2
        ...
        x459B_7 = {7, 0x459B}; x459B_7 = locFlag(x459B_7); if canBirdo() and optionHardLogic() and has("RedGoblet") and has("Thunderhand") then canrBowser = canrBowser + flip(x459B_7) end; sumrBowser = sumrBowser - x459B_7 --Bowser's Castle Great Door Block 1
        x459C_0 = {0, 0x459C}; x459C_0 = locFlag(x459C_0); if canBirdo() and optionHardLogic() and has("RedGoblet") and has("Thunderhand") then canrBowser = canrBowser + flip(x459C_0) end; sumrBowser = sumrBowser - x459C_0 --Bowser's Castle Great Door Block 2
        ...
        x459E_2 = {2, 0x459E}; x459E_2 = locFlag(x459E_2); if canBirdo() and optionHardLogic() and has("RedGoblet") and has("Thunderhand") then canrBowser = canrBowser + flip(x459E_2) end; sumrBowser = sumrBowser - x459E_2 --Bowser's Castle Larry Room Block
        ...
        x459B_0 = {0, 0x459B}; x459B_0 = locFlag(x459B_0); if canBirdo() and optionHardLogic() and has("RedGoblet") and has("Thunderhand") then canrBowser = canrBowser + flip(x459B_0) end; sumrBowser = sumrBowser - x459B_0 --Bowser's Castle Ludwig & Roy Hallway Block 1
        x459B_1 = {1, 0x459B}; x459B_1 = locFlag(x459B_1); if canBirdo() and optionHardLogic() and has("RedGoblet") and has("Thunderhand") then canrBowser = canrBowser + flip(x459B_1) end; sumrBowser = sumrBowser - x459B_1 --Bowser's Castle Ludwig & Roy Hallway Block 2
        ...
        x459C_7 = {7, 0x459C}; x459C_7 = locFlag(x459C_7); if canBirdo() and optionHardLogic() and has("RedGoblet") and has("Thunderhand") then canrBowser = canrBowser + flip(x459C_7) end; sumrBowser = sumrBowser - x459C_7 --Bowser's Castle Mini Mario Maze Block 1
        x459D_0 = {0, 0x459D}; x459D_0 = locFlag(x459D_0); if canBirdo() and optionHardLogic() and has("RedGoblet") and has("Thunderhand") then canrBowser = canrBowser + flip(x459D_0) end; sumrBowser = sumrBowser - x459D_0 --Bowser's Castle Mini Mario Maze Block 2
        x459C_5 = {5, 0x459C}; x459C_5 = locFlag(x459C_5); if canBirdo() and optionHardLogic() and has("RedGoblet") and has("Thunderhand") then canrBowser = canrBowser + flip(x459C_5) end; sumrBowser = sumrBowser - x459C_5 --Bowser's Castle Mini Mario Sidescroller Block 1
        x459C_6 = {6, 0x459C}; x459C_6 = locFlag(x459C_6); if canBirdo() and optionHardLogic() and has("RedGoblet") and has("Thunderhand") then canrBowser = canrBowser + flip(x459C_6) end; sumrBowser = sumrBowser - x459C_6 --Bowser's Castle Mini Mario Sidescroller Block 2
        ...
        x459B_2 = {2, 0x459B}; x459B_2 = locFlag(x459B_2); if canBirdo() and optionHardLogic() and has("RedGoblet") and has("Thunderhand") then canrBowser = canrBowser + flip(x459B_2) end; sumrBowser = sumrBowser - x459B_2 --Bowser's Castle Roy Corridor Block 1
        x459B_3 = {3, 0x459B}; x459B_3 = locFlag(x459B_3); if canBirdo() and optionHardLogic() and has("RedGoblet") and has("Thunderhand") then canrBowser = canrBowser + flip(x459B_3) end; sumrBowser = sumrBowser - x459B_3 --Bowser's Castle Roy Corridor Block 2
        if optionDigspots() >= 1 then x459B_4 = {4, 0x459B}; x459B_4 = locFlag(x459B_4); if canBirdo() and optionHardLogic() and has("RedGoblet") and has("Thunderhand") then canrBowser = canrBowser + flip(x459B_4) end; sumrBowser = sumrBowser - x459B_4 end --Bowser's Castle Wendy & Larry Hallway Digspot
    end --
    ...
    x4346_6 = {6, 0x4346}; x4346_6 = locFlag(x4346_6); if canGwarhar() and canFirebrand() and has("Thunderhand") then canrGwarhar = canrGwarhar + flip(x4346_6) end; sumrGwarhar = sumrGwarhar - x4346_6 --Gwarhar Lagoon Green Pearl Bean
    x4346_7 = {7, 0x4346}; x4346_7 = locFlag(x4346_7); if canGwarhar() and canFirebrand() and has("Thunderhand") then canrGwarhar = canrGwarhar + flip(x4346_7) end; sumrGwarhar = sumrGwarhar - x4346_7 --Gwarhar Lagoon Red Pearl Bean
	...
	if optionBowser() then
		drawLocation(canrBowser, sumrBowser, "./location_names/TOTAL1.png", "./location_names/TOTAL2.png", "./location_names/TOTAL3.png", 800)

...
function loadLocFlags()
    ...
    if optionDigspots() == 1 then x4589_5 = {5, 0x4589}; x4589_5 = locFlag(x4589_5); if has("Thunderhand") and canDig() then canrOutskirts = canrOutskirts + flip(x4589_5); sumrOutskirts = sumrOutskirts - x4589_5 end end --Airport Center Digspot 5
    ...
    if optionDigspots() == 1 then x458A_2 = {2, 0x458A}; x458A_2 = locFlag(x458A_2); if has("Thunderhand") and canDig() then canrOutskirts = canrOutskirts + flip(x458A_2); sumrOutskirts = sumrOutskirts - x458A_2 end end --Airport Eastside Digspot 5
    if optionDigspots() == 1 then x4588_2 = {2, 0x4588}; x4588_2 = locFlag(x4588_2); if has("Thunderhand") and canDig() then canrOutskirts = canrOutskirts + flip(x4588_2); sumrOutskirts = sumrOutskirts - x4588_2 end end --Airport Entrance Digspot
    if optionDigspots() == 1 then x4588_3 = {3, 0x4588}; x4588_3 = locFlag(x4588_3); if has("Thunderhand") and canDig() then canrOutskirts = canrOutskirts + flip(x4588_3); sumrOutskirts = sumrOutskirts - x4588_3 end end --Airport Lobby Digspot
    ...
    if optionDigspots() == 1 then x4589_0 = {0, 0x4589}; x4589_0 = locFlag(x4589_0); if has("Thunderhand") and canDig() then canrOutskirts = canrOutskirts + flip(x4589_0); sumrOutskirts = sumrOutskirts - x4589_0 end end --Airport Westside Digspot 5
    ...
    if optionDigspots() == 1 then x4598_5 = {5, 0x4598}; x4598_5 = locFlag(x4598_5); if canCrash() and canDig() then canrOutskirts = canrOutskirts + flip(x4598_5); sumrOutskirts = sumrOutskirts - x4598_5 end end --Beanbean Outskirts Before Harhall Digspot 2
    ...
    if optionDigspots() == 1 then x4599_1 = {1, 0x4599}; x4599_1 = locFlag(x4599_1); if canDig() and has("BeanbeanBrooch") then canrOutskirts = canrOutskirts + flip(x4599_1); sumrOutskirts = sumrOutskirts - x4599_1 end end --Beanbean Outskirts Chateau Entrance Digspot 2
    ...
    if optionDigspots() == 1 then x4571_6 = {6, 0x4571}; x4571_6 = locFlag(x4571_6); if canDig() and has("Thunderhand") then canrOutskirts = canrOutskirts + flip(x4571_6); sumrOutskirts = sumrOutskirts - x4571_6 end end --Beanbean Outskirts Farm Room Digspot 2
    if optionDigspots() == 1 then x4571_7 = {7, 0x4571}; x4571_7 = locFlag(x4571_7); if canDig() and has("Thunderhand") then canrOutskirts = canrOutskirts + flip(x4571_7); sumrOutskirts = sumrOutskirts - x4571_7 end end --Beanbean Outskirts Farm Room Digspot 3
    ...
    if optionDigspots() == 1 then x4576_1 = {1, 0x4576}; x4576_1 = locFlag(x4576_1); if canDig() then canrOutskirts = canrOutskirts + flip(x4576_1); sumrOutskirts = sumrOutskirts - x4576_1 end end --Beanbean Outskirts NE Digspot 2
    ...
    if optionDigspots() == 1 then x4577_3 = {3, 0x4577}; x4577_3 = locFlag(x4577_3); if canDig() then canrOutskirts = canrOutskirts + flip(x4577_3); sumrOutskirts = sumrOutskirts - x4577_3 end end --Beanbean Outskirts North Beach Digspot 2
    ...
    if optionDigspots() == 1 then x459E_6 = {6, 0x459E}; x459E_6 = locFlag(x459E_6); if canDig() then canrOutskirts = canrOutskirts + flip(x459E_6); sumrOutskirts = sumrOutskirts - x459E_6 end end --Beanbean Outskirts Pipe 2 Room Digspot
    if optionDigspots() == 1 then x459E_7 = {7, 0x459E}; x459E_7 = locFlag(x459E_7); if canDig() then canrOutskirts = canrOutskirts + flip(x459E_7); sumrOutskirts = sumrOutskirts - x459E_7 end end --Beanbean Outskirts Pipe 4 Room Digspot
    ...
    if optionDigspots() == 1 then x4575_6 = {6, 0x4575}; x4575_6 = locFlag(x4575_6); if canCrash() and canDig() then canrOutskirts = canrOutskirts + flip(x4575_6); sumrOutskirts = sumrOutskirts - x4575_6 end end --Beanbean Outskirts S Room 2 Digspot 1
    if optionDigspots() == 1 then x4575_5 = {5, 0x4575}; x4575_5 = locFlag(x4575_5); if canCrash() and canDig() then canrOutskirts = canrOutskirts + flip(x4575_5); sumrOutskirts = sumrOutskirts - x4575_5 end end --Beanbean Outskirts S Room 2 Digspot 2
    ...
    if optionDigspots() == 1 then x4577_0 = {0, 0x4577}; x4577_0 = locFlag(x4577_0); if canDig() then canrOutskirts = canrOutskirts + flip(x4577_0); sumrOutskirts = sumrOutskirts - x4577_0 end end --Beanbean Outskirts SE Digspot 3
    ...
    if optionDigspots() == 1 then x4574_0 = {0, 0x4574}; x4574_0 = locFlag(x4574_0); if canDig() then canrOutskirts = canrOutskirts + flip(x4574_0); sumrOutskirts = sumrOutskirts - x4574_0 end end --Beanbean Outskirts SW Digspot 3
    ...
    if optionDigspots() == 1 then x4599_4 = {4, 0x4599}; x4599_4 = locFlag(x4599_4); if canDig() then canrOutskirts = canrOutskirts + flip(x4599_4); sumrOutskirts = sumrOutskirts - x4599_4 end end --Beanbean Outskirts South of Hooniversity Guards Digspot 3
    ...
    if optionDigspots() == 1 then x4578_0 = {0, 0x4578}; x4578_0 = locFlag(x4578_0); if canSurf() and canDig() then canrOutskirts = canrOutskirts + flip(x4578_0); sumrOutskirts = sumrOutskirts - x4578_0 end end --Beanbean Outskirts Surf Beach Digspot 3
    ...
    if optionDigspots() == 1 then x4573_4 = {4, 0x4573}; x4573_4 = locFlag(x4573_4); if canDig() then canrOutskirts = canrOutskirts + flip(x4573_4); sumrOutskirts = sumrOutskirts - x4573_4 end end --Beanbean Outskirts W Digspot 3
  ...
  -- if optionDigspots() == 1 then  end --Bowser's Castle Wendy & Larry Hallway Digspot
    ...
    if optionDigspots() == 1 then x457F_1 = {1, 0x457F}; x457F_1 = locFlag(x457F_1); if has("BeanbeanBrooch") and canDig() then canrChucklehuck = canrChucklehuck + flip(x457F_1); sumrChucklehuck = sumrChucklehuck - x457F_1 end end --Chucklehuck Woods Koopa Room Digspot
    ...
    if optionDigspots() == 1 then x457A_6 = {6, 0x457A}; x457A_6 = locFlag(x457A_6); if has("BeanbeanBrooch") and canDig() then canrChucklehuck = canrChucklehuck + flip(x457A_6); sumrChucklehuck = sumrChucklehuck - x457A_6 end end --Chucklehuck Woods Pipe Room Digspot 2
    ...
    if optionDigspots() == 1 then x4585_1 = {1, 0x4585}; x4585_1 = locFlag(x4585_1); if has("BeanbeanBrooch") and canDig() then canrChucklehuck = canrChucklehuck + flip(x4585_1); sumrChucklehuck = sumrChucklehuck - x4585_1 end end --Chucklehuck Woods Room 1 Digspot
    ...
    if optionDigspots() == 1 then x457C_7 = {7, 0x457C}; x457C_7 = locFlag(x457C_7); if has("BeanbeanBrooch") and canGoblets() then canrChucklehuck = canrChucklehuck + flip(x457C_7); sumrChucklehuck = sumrChucklehuck - x457C_7 end end --Chucklehuck Woods White Fruit Room Digspot 3
    ...
    if optionDigspots() == 1 then x457D_3 = {3, 0x457D}; x457D_3 = locFlag(x457D_3); if has("BeanbeanBrooch") and canDig() then canrChucklehuck = canrChucklehuck + flip(x457D_3); sumrChucklehuck = sumrChucklehuck - x457D_3 end end --Chucklehuck Woods Wiggler room Digspot 2
    ...
    if optionDigspots() == 1 then x458A_4 = {4, 0x458A}; x458A_4 = locFlag(x458A_4); if canGwarhar() and canDig() then canrGwarhar = canrGwarhar + flip(x458A_4); sumrGwarhar = sumrGwarhar - x458A_4 end end --Gwarhar Lagoon Massage Parlor Entrance Digspot
    ...
    if optionDigspots() == 1 then x458B_0 = {0, 0x458B}; x458B_0 = locFlag(x458B_0); if canGwarharDeep() and canDig() then canrGwarhar = canrGwarhar + flip(x458B_0); sumrGwarhar = sumrGwarhar - x458B_0 end end --Gwarhar Lagoon Fire Dash Puzzle Room 1 Digspot 2
    ...
    if optionDigspots() == 1 then x458B_3 = {3, 0x458B}; x458B_3 = locFlag(x458B_3); if canGwarharDeep() and canDig() then canrGwarhar = canrGwarhar + flip(x458B_3); sumrGwarhar = sumrGwarhar - x458B_3 end end --Gwarhar Lagoon Fire Dash Puzzle Room 3 Digspot 2
    ...
    if optionDigspots() == 1 then x458C_6 = {6, 0x458C}; x458C_6 = locFlag(x458C_6); if canGwarharDeep() and canDig() then canrGwarhar = canrGwarhar + flip(x458C_6); sumrGwarhar = sumrGwarhar - x458C_6 end end --Gwarhar Lagoon Second Underwater Area Room 2 Digspot 2
    ...
    if optionDigspots() == 1 then x458C_4 = {4, 0x458C}; x458C_4 = locFlag(x458C_4); if canGwarharDeep() and canDig() then canrGwarhar = canrGwarhar + flip(x458C_4); sumrGwarhar = sumrGwarhar - x458C_4 end end --Gwarhar Lagoon Second Underwater Area Room 4 Digspot
    ...
    if optionHarhall() then x434D_3 = {3, 0x434D}; x434D_3 = locFlag(x434D_3); if canCrash() then canrOutskirts = canrOutskirts + flip(x434D_3); sumrOutskirts = sumrOutskirts - x434D_3 end end --Harhall's Pants
    ...
    if optionDigspots() == 1 then x456E_3 = {3, 0x456E}; x456E_3 = locFlag(x456E_3); if has("Hammers3") and canDig() then canrHoohoo = canrHoohoo + flip(x456E_3); sumrHoohoo = sumrHoohoo - x456E_3 end end --Hoohoo Mountain Base Boostatue Room Digspot 3 (Right Side)
    ...
    if optionDigspots() == 1 and optionMinecart() then x4571_4 = {4, 0x4571}; x4571_4 = locFlag(x4571_4); if canDig() then canrHoohoo = canrHoohoo + flip(x4571_4); sumrHoohoo = sumrHoohoo - x4571_4 end end --Hoohoo Mountain Base Minecart Cave Digspot
    ...
    if optionDigspots() == 1 then x456A_6 = {6, 0x456A}; x456A_6 = locFlag(x456A_6); if canDig() then canrHoohoo = canrHoohoo + flip(x456A_6); sumrHoohoo = sumrHoohoo - x456A_6 end end --Hoohoo Mountain Hoohooros Room Digspot 2
    ...
    if optionDigspots() == 1 then x4597_7 = {7, 0x4597}; x4597_7 = locFlag(x4597_7); if canDig() then canrHoohoo = canrHoohoo + flip(x4597_7); sumrHoohoo = sumrHoohoo - x4597_7 end end --Hoohoo Mountain Past Hoohooros Connector Room Digspot 2
    ...
    if optionDigspots() == 1 then x456B_5 = {5, 0x456B}; x456B_5 = locFlag(x456B_5); if canDig() then canrHoohoo = canrHoohoo + flip(x456B_5); sumrHoohoo = sumrHoohoo - x456B_5 end end --Hoohoo Mountain Room 2 Digspot 2
    ...
    if optionDigspots() == 1 then x4570_3 = {3, 0x4570}; x4570_3 = locFlag(x4570_3); if canDig() then canrHoohoo = canrHoohoo + flip(x4570_3); sumrHoohoo = sumrHoohoo - x4570_3 end end --Hoohoo Village North Cave Room 2 Digspot
    ...
    if optionDigspots() == 1 then x4571_3 = {3, 0x4571}; x4571_3 = locFlag(x4571_3); if canDig() and (canCrash() or has("Hammers2")) then canrHoohoo = canrHoohoo + flip(x4571_3); sumrHoohoo = sumrHoohoo - x4571_3 end end --Hoohoo Village Super Hammer Cave Digspot
    ...
    if optionDigspots() == 1 then x4592_7 = {7, 0x4592}; x4592_7 = locFlag(x4592_7); if canJokes() and canDig() then canrJokes = canrJokes + flip(x4592_7); sumrJokes = sumrJokes - x4592_7 end end --Joke's End First Boiler Room Digspot 2
    if optionDigspots() == 1 then x4592_2 = {2, 0x4592}; x4592_2 = locFlag(x4592_2); if canSurf() and canDig() then canrJokes = canrJokes + flip(x4592_2); sumrJokes = sumrJokes - x4592_2 end end --Joke's End Pipe Digspot
    ...
    if optionDigspots() == 1 then x4592_3 = {3, 0x4592}; x4592_3 = locFlag(x4592_3); if canSurf() and canDig() then canrJokes = canrJokes + flip(x4592_3); sumrJokes = sumrJokes - x4592_3 end end --Joke's End Staircase Digspot
    ...
    if optionDigspots() == 1 then x4598_3 = {3, 0x4598}; x4598_3 = locFlag(x4598_3); if canJokesDeep() and has("RedPearlBean") then canrJokes = canrJokes + flip(x4598_3); sumrJokes = sumrJokes - x4598_3 end end --Joke's End Jojora Room Digspot
    ...
    if optionDigspots() == 1 then x4596_3 = {3, 0x4596}; x4596_3 = locFlag(x4596_3); if canJokesDeep() then canrJokes = canrJokes + flip(x4596_3); sumrJokes = sumrJokes - x4596_3 end end --Joke's End Second Boiler Room Digspot 2
    ...
    if optionDigspots() == 1 then x4582_3 = {3, 0x4582}; x4582_3 = locFlag(x4582_3); if canSurf() and canDig() then canrOasis = canrOasis + flip(x4582_3); sumrOasis = sumrOasis - x4582_3 end end --Oho Ocean North Whirlpool Digspot 2
    ...
    if optionDigspots() == 1 then x4581_3 = {3, 0x4581}; x4581_3 = locFlag(x4581_3); if canGwarhar() and canDig() then canrOasis = canrOasis + flip(x4581_3); sumrOasis = sumrOasis - x4581_3 end end --Oho Ocean South Room 2 Digspot
    ...
    if optionDigspots() == 1 then x4583_0 = {0, 0x4583}; x4583_0 = locFlag(x4583_0); if canSurf() and canDig() then canrOasis = canrOasis + flip(x4583_0); sumrOasis = sumrOasis - x4583_0 end end --Oho Ocean South Whirlpool Digspot 5
    if optionDigspots() == 1 then x4583_1 = {1, 0x4583}; x4583_1 = locFlag(x4583_1); if canSurf() and canDig() then canrOasis = canrOasis + flip(x4583_1); sumrOasis = sumrOasis - x4583_1 end end --Oho Ocean South Whirlpool Digspot 6
    ...
    if optionDigspots() == 1 then x4581_5 = {5, 0x4581}; x4581_5 = locFlag(x4581_5); if canOasis() and canDig() then canrOasis = canrOasis + flip(x4581_5); sumrOasis = sumrOasis - x4581_5 end end --Oho Ocean Spike Room Digspot 2
    ...
    if optionSurfing() then x4375_1 = {1, 0x4375}; x4375_1 = locFlag(x4375_1); if canSurf() then canrOasis = canrOasis + flip(x4375_1); sumrOasis = sumrOasis - x4375_1 end end --Surf Minigame
    ...
    if optionDigspots() == 1 then x4590_7 = {7, 0x4590}; x4590_7 = locFlag(x4590_7); if canTeehee() and canDig() then canrTeehee = canrTeehee + flip(x4590_7); sumrTeehee = sumrTeehee - x4590_7 end end --Teehee Valley Before Trunkle Digspot
    if optionDigspots() == 1 then x4590_3 = {3, 0x4590}; x4590_3 = locFlag(x4590_3); if has("Hammers3") and canDig() then canrTeehee = canrTeehee + flip(x4590_3); sumrTeehee = sumrTeehee - x4590_3 end end --Teehee Valley Entrance To Hoohoo Mountain Digspot
    ...
    if optionDigspots() == 1 then x458E_3 = {3, 0x458E}; x458E_3 = locFlag(x458E_3); if canTeehee() and canDig() then canrTeehee = canrTeehee + flip(x458E_3); sumrTeehee = sumrTeehee - x458E_3 end end --Teehee Valley Room 1 Digspot 1
    ...
    if optionDigspots() == 1 then x4591_0 = {0, 0x4591}; x4591_0 = locFlag(x4591_0); if canFungitown() and canDig() then canrTeehee = canrTeehee + flip(x4591_0); sumrTeehee = sumrTeehee - x4591_0 end end --Teehee Valley Trunkle Room Digspot
    ...
    if optionDigspots() == 1 then x4590_4 = {4, 0x4590}; x4590_4 = locFlag(x4590_4); if has("Hammers3") and canDig() then canrTeehee = canrTeehee + flip(x4590_4); sumrTeehee = sumrTeehee - x4590_4 end end --Teehee Valley Upper Maze Room 2 Digspot 1
    if optionDigspots() == 1 then x4590_5 = {5, 0x4590}; x4590_5 = locFlag(x4590_5); if has("Hammers3") and canDig() then canrTeehee = canrTeehee + flip(x4590_5); sumrTeehee = sumrTeehee - x4590_5 end end --Teehee Valley Upper Maze Room 2 Digspot 2
    ...
    if optionDigspots() == 1 then x4596_6 = {6, 0x4596}; x4596_6 = locFlag(x4596_6); if has("BeanbeanBrooch") and canDash() and canDig() then canrChucklehuck = canrChucklehuck + flip(x4596_6); sumrChucklehuck = sumrChucklehuck - x4596_6 end end --Winkle Area Colloseum Digspot
    ...
    if optionDigspots() == 1 then x4585_0 = {0, 0x4585}; x4585_0 = locFlag(x4585_0); if canGoblets() then canrHooniversity = canrHooniversity + flip(x4585_0); sumrHooniversity = sumrHooniversity - x4585_0 end end --Woohoo Hooniversity Barrel Puzzle Entrance Digspot 2
    ...
    if optionDigspots() == 1 then x4586_3 = {3, 0x4586}; x4586_3 = locFlag(x4586_3); if canDig() then canrHooniversity = canrHooniversity + flip(x4586_3); sumrHooniversity = sumrHooniversity - x4586_3 end end --Woohoo Hooniversity Entrance to Mini Mario Room Digspot 2
    ...
    if optionDigspots() == 1 then x4585_3 = {3, 0x4585}; x4585_3 = locFlag(x4585_3); if canDig() then canrHooniversity = canrHooniversity + flip(x4585_3); sumrHooniversity = sumrHooniversity - x4585_3 end end --Woohoo Hooniversity West of Star Room 3 Digspot
    ...
    if optionDigspots() == 1 then x4586_1 = {1, 0x4586}; x4586_1 = locFlag(x4586_1); if canDig() then canrHooniversity = canrHooniversity + flip(x4586_1); sumrHooniversity = sumrHooniversity - x4586_1 end end --Woohoo Hooniversity West of Star Room 5 Digspot
    ...
    if optionDigspots() == 1 then x4584_2 = {2, 0x4584}; x4584_2 = locFlag(x4584_2); if canDig() then canrHooniversity = canrHooniversity + flip(x4584_2); sumrHooniversity = sumrHooniversity - x4584_2 end end --Woohoo Hooniversity West of Star Room Digspot 2

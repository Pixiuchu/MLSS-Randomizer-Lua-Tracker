...
function loadLocFlags()
    ...
    if optionDigspots() > 1 then x4589_1 = {1, 0x4589}; x4589_1 = locFlag(x4589_1); if canThunderhand() and canDig() then canrOutskirts = canrOutskirts + flip(x4589_1); sumrOutskirts = sumrOutskirts - x4589_1 end end --Airport Center Digspot 1
    if optionDigspots() > 1 then x4589_2 = {2, 0x4589}; x4589_2 = locFlag(x4589_2); if canThunderhand() and canDig() then canrOutskirts = canrOutskirts + flip(x4589_2); sumrOutskirts = sumrOutskirts - x4589_2 end end --Airport Center Digspot 2
    if optionDigspots() > 1 then x4589_3 = {3, 0x4589}; x4589_3 = locFlag(x4589_3); if canThunderhand() and canDig() then canrOutskirts = canrOutskirts + flip(x4589_3); sumrOutskirts = sumrOutskirts - x4589_3 end end --Airport Center Digspot 3
    if optionDigspots() > 1 then x4589_4 = {4, 0x4589}; x4589_4 = locFlag(x4589_4); if canThunderhand() and canDig() then canrOutskirts = canrOutskirts + flip(x4589_4); sumrOutskirts = sumrOutskirts - x4589_4 end end --Airport Center Digspot 4
    if optionDigspots() == 2 then x4589_5 = {5, 0x4589}; x4589_5 = locFlag(x4589_5); if canThunderhand() and canDig() then canrOutskirts = canrOutskirts + flip(x4589_5); sumrOutskirts = sumrOutskirts - x4589_5 end end --Airport Center Digspot 5
    if optionDigspots() > 1 then x4589_6 = {6, 0x4589}; x4589_6 = locFlag(x4589_6); if canThunderhand() and canDig() then canrOutskirts = canrOutskirts + flip(x4589_6); sumrOutskirts = sumrOutskirts - x4589_6 end end --Airport Eastside Digspot 1
    if optionDigspots() > 1 then x4589_7 = {7, 0x4589}; x4589_7 = locFlag(x4589_7); if canThunderhand() and canDig() then canrOutskirts = canrOutskirts + flip(x4589_7); sumrOutskirts = sumrOutskirts - x4589_7 end end --Airport Eastside Digspot 2
    if optionDigspots() > 1 then x458A_0 = {0, 0x458A}; x458A_0 = locFlag(x458A_0); if canThunderhand() and canDig() then canrOutskirts = canrOutskirts + flip(x458A_0); sumrOutskirts = sumrOutskirts - x458A_0 end end --Airport Eastside Digspot 3
    if optionDigspots() > 1 then x458A_1 = {1, 0x458A}; x458A_1 = locFlag(x458A_1); if canThunderhand() and canDig() then canrOutskirts = canrOutskirts + flip(x458A_1); sumrOutskirts = sumrOutskirts - x458A_1 end end --Airport Eastside Digspot 4
    if optionDigspots() == 2 then x458A_2 = {2, 0x458A}; x458A_2 = locFlag(x458A_2); if canThunderhand() and canDig() then canrOutskirts = canrOutskirts + flip(x458A_2); sumrOutskirts = sumrOutskirts - x458A_2 end end --Airport Eastside Digspot 5
    if optionDigspots() == 2 then x4588_2 = {2, 0x4588}; x4588_2 = locFlag(x4588_2); if canThunderhand() and canDig() then canrOutskirts = canrOutskirts + flip(x4588_2); sumrOutskirts = sumrOutskirts - x4588_2 end end --Airport Entrance Digspot
    if optionDigspots() == 2 then x4588_3 = {3, 0x4588}; x4588_3 = locFlag(x4588_3); if canThunderhand() and canDig() then canrOutskirts = canrOutskirts + flip(x4588_3); sumrOutskirts = sumrOutskirts - x4588_3 end end --Airport Lobby Digspot
    if optionDigspots() > 1 then x4588_4 = {4, 0x4588}; x4588_4 = locFlag(x4588_4); if canThunderhand() and canDig() then canrOutskirts = canrOutskirts + flip(x4588_4); sumrOutskirts = sumrOutskirts - x4588_4 end end --Airport Westside Digspot 1
    if optionDigspots() > 1 then x4588_5 = {5, 0x4588}; x4588_5 = locFlag(x4588_5); if canThunderhand() and canDig() then canrOutskirts = canrOutskirts + flip(x4588_5); sumrOutskirts = sumrOutskirts - x4588_5 end end --Airport Westside Digspot 2
    if optionDigspots() > 1 then x4588_6 = {6, 0x4588}; x4588_6 = locFlag(x4588_6); if canThunderhand() and canDig() then canrOutskirts = canrOutskirts + flip(x4588_6); sumrOutskirts = sumrOutskirts - x4588_6 end end --Airport Westside Digspot 3
    if optionDigspots() > 1 then x4588_7 = {7, 0x4588}; x4588_7 = locFlag(x4588_7); if canThunderhand() and canDig() then canrOutskirts = canrOutskirts + flip(x4588_7); sumrOutskirts = sumrOutskirts - x4588_7 end end --Airport Westside Digspot 4
    if optionDigspots() == 2 then x4589_0 = {0, 0x4589}; x4589_0 = locFlag(x4589_0); if canThunderhand() and canDig() then canrOutskirts = canrOutskirts + flip(x4589_0); sumrOutskirts = sumrOutskirts - x4589_0 end end --Airport Westside Digspot 5
    ...
    if optionDigspots() > 1 then x4576_3 = {3, 0x4576}; x4576_3 = locFlag(x4576_3); if canDig() and canThunderhand() then canrOutskirts = canrOutskirts + flip(x4576_3); sumrOutskirts = sumrOutskirts - x4576_3 end end --Beanbean Outskirts E Digspot 2
    ...
    if optionDigspots() > 1 then x4571_5 = {5, 0x4571}; x4571_5 = locFlag(x4571_5); if canDig() and canThunderhand() then canrOutskirts = canrOutskirts + flip(x4571_5); sumrOutskirts = sumrOutskirts - x4571_5 end end --Beanbean Outskirts Farm Room Digspot 1
    if optionDigspots() == 2 then x4571_6 = {6, 0x4571}; x4571_6 = locFlag(x4571_6); if canDig() and canThunderhand() then canrOutskirts = canrOutskirts + flip(x4571_6); sumrOutskirts = sumrOutskirts - x4571_6 end end --Beanbean Outskirts Farm Room Digspot 2
    if optionDigspots() == 2 then x4571_7 = {7, 0x4571}; x4571_7 = locFlag(x4571_7); if canDig() and canThunderhand() then canrOutskirts = canrOutskirts + flip(x4571_7); sumrOutskirts = sumrOutskirts - x4571_7 end end --Beanbean Outskirts Farm Room Digspot 3
    x434B_0 = {0, 0x434B}; x434B_0 = locFlag(x434B_0); if canThunderhand() then canrOutskirts = canrOutskirts + flip(x434B_0); sumrOutskirts = sumrOutskirts - x434B_0 end --Beanbean Outskirts Farm Room Mole Reward 1
    x434B_0 = {0, 0x434B}; x434B_0 = locFlag(x434B_0); if canThunderhand() then canrOutskirts = canrOutskirts + flip(x434B_0); sumrOutskirts = sumrOutskirts - x434B_0 end --Beanbean Outskirts Farm Room Mole Reward 2
    ...
    if optionDigspots() > 1 then x4576_0 = {0, 0x4576}; x4576_0 = locFlag(x4576_0); if canDig() and canThunderhand() then canrOutskirts = canrOutskirts + flip(x4576_0); sumrOutskirts = sumrOutskirts - x4576_0 end end --Beanbean Outskirts NE Digspot 1
    ...
    x4574_6 = {6, 0x4574}; x4574_6 = locFlag(x4574_6); if canThunderhand() and has("Hammers3") then canrOutskirts = canrOutskirts + flip(x4574_6); sumrOutskirts = sumrOutskirts - x4574_6 end --Beanbean Outskirts S Room 1 Block
    if optionCoins() then x4574_5 = {5, 0x4574}; x4574_5 = locFlag(x4574_5); if canThunderhand() and has("Hammers3") then canrOutskirts = canrOutskirts + flip(x4574_5); sumrOutskirts = sumrOutskirts - x4574_5 end end --Beanbean Outskirts S Room 1 Coin Block
    ...
    if optionDigspots() > 1 then x4574_7 = {7, 0x4574}; x4574_7 = locFlag(x4574_7); if canThunderhand() and has("Hammers3") and canDig() then canrOutskirts = canrOutskirts + flip(x4574_7); sumrOutskirts = sumrOutskirts - x4574_7 end end --Beanbean Outskirts S Room 1 Digspot 2
    ...
    x434E_1 = {1, 0x434E}; x434E_1 = locFlag(x434E_1); if canThunderhand() and has("Hammers2") then canrOutskirts = canrOutskirts + flip(x434E_1); sumrOutskirts = sumrOutskirts - x434E_1 end --Beanbean Outskirts Secret Scroll 1
    x434E_2 = {2, 0x434E}; x434E_2 = locFlag(x434E_2); if canThunderhand() and has("Hammers3") then canrOutskirts = canrOutskirts + flip(x434E_2); sumrOutskirts = sumrOutskirts - x434E_2 end --Beanbean Outskirts Secret Scroll 2
    ...
    x4359_5 = {5, 0x4359}; x4359_5 = locFlag(x4359_5); if canThunderhand() then canrOutskirts = canrOutskirts + flip(x4359_5); sumrOutskirts = sumrOutskirts - x4359_5 end --Beanbean Outskirts Super Hammer Upgrade
    ...
    x4373_3 = {3, 0x4373}; x4373_3 = locFlag(x4373_3); if canThunderhand() then canrOutskirts = canrOutskirts + flip(x4373_3); sumrOutskirts = sumrOutskirts - x4373_3 end --Beanbean Outskirts Thunderhand Mole
    x4359_6 = {6, 0x4359}; x4359_6 = locFlag(x4359_6); if canThunderhand() and canBeanstar() then canrOutskirts = canrOutskirts + flip(x4359_6); sumrOutskirts = sumrOutskirts - x4359_6 end --Beanbean Outskirts Ultra Hammer Upgrade
    ...
    x4346_6 = {6, 0x4346}; x4346_6 = locFlag(x4346_6); if canGwarhar() and canFirebrand() and canThunderhand() then canrGwarhar = canrGwarhar + flip(x4346_6); sumrGwarhar = sumrGwarhar - x4346_6 end --Gwarhar Lagoon Green Pearl Bean
    x4346_7 = {7, 0x4346}; x4346_7 = locFlag(x4346_7); if canGwarhar() and canFirebrand() and canThunderhand() then canrGwarhar = canrGwarhar + flip(x4346_7); sumrGwarhar = sumrGwarhar - x4346_7 end --Gwarhar Lagoon Red Pearl Bean

...
function loadLocFlags()
    ...
    if has("SpangleComplete") or (canGwarharDeep() and canCrash() and has("Spangle")) then local x434A_7 = {7, 0x434A}; x434A_7 = locFlag(x434A_7); canrGwarhar = canrGwarhar + flip(x434A_7); sumrGwarhar = sumrGwarhar - x434A_7 end --Gwarhar Lagoon Spangle Reward
